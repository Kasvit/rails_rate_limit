...
RSpec.describe RailsRateLimit::Controller do
  ...
  describe ".controller_rate_limit" do
    it "adds class method to the including class" do
      expect(controller_class).to respond_to(:controller_rate_limit)
    end
